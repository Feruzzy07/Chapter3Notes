...
let Class = ['Barbarian', 'Hunter', 'Healer', 'Nerd', 'Peasent', 'King', 'Wizard'];
let specialSkill = ['Singing', 'Killing', 'Torturing', 'Dancing', 'Archery', 'Horse Rider', 'Eating'];
let money = [12, 1094, 94097832, 93892, 4942, 192, 0, 92, 5923];
let character1 = {
    //empty for now
};
let character2 = {
...
function createChar(character, list){
    ...
    character.money = pickRandomChoice(money);
